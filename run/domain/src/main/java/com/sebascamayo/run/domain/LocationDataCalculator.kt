...
// Logica para obtener la distancia entre puntos de localizacion
// Se utilizan funciones de Location que da logica general de fisica
...
object LocationDataCalculator {
    ...
    fun getTotalDistanceMeters(locations: List<List<LocationTimestamp>>): Int {
        return locations
            .sumOf { timestampsPerLine ->
                ...
                // zipWithNext crea coleccion de tuplas de forma constante con el siguiente
                // En este caso se crea una coleccion de distancias que se suman al final
    ...
    fun getMaxSpeedKmh(locations: List<List<LocationTimestamp>>): Double {
        return locations.maxOf { locationTimestamp ->

            locationTimestamp.zipWithNext { location1, location2 ->
    ...
    fun getTotalElevationMeters(locations: List<List<LocationTimestamp>>): Int {
        return locations.sumOf { locationStamp ->
            locationStamp.zipWithNext { location1, location2 ->
